import java.awt.*;
import java.applet.*;
/* <applet code="GraphicsText.class" width=500 height=500> </applet> */
public class GraphicsText extends Applet 	
{
		public void paint(Graphics g) 
		{
				Dimension d = getSize( ) ; 		// returns the width and height  of the applet
				...
				Color myColor = new Color(255,100,150);    // set a RGB color
							// A color can be choosen, R, G, B  integers ranges between  0 to 255
				g.setColor(myColor );
